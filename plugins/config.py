...
class Config(object):
    ...
    HTTP_PROXY = os.environ.get("HTTP_PROXY", "219.65.73.81:80")
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Ansh089:Ansh089@cluster0.y8tpouc.mongodb.net/?retryWrites=true&w=majority")

    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002284232975"))
    LOGGER = logging
    OWNER_ID = int(os.environ.get("OWNER_ID", "5961011848"))
    SESSION_NAME = "UploaderXNTBot"
    UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "")

    TG_MIN_FILE_SIZE = 2194304000
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Sjsnwiwjjsj_bot")
    ADL_BOT_RQ = {}
